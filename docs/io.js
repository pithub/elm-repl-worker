...
var $author$project$Extra$System$IO$Port$lowLevelSend = F3(
	function (codec, sendPort, value) {
				...
				return $author$project$Extra$System$IO$sequence(
					_List_fromArray(
						[
							...
							A3($author$project$Extra$System$IO$Port$lowLevelSend, requestCodec, requestPort, requestOut)
						]));
			});
	});
		...
		return receivePort(
			function (requestWire) {
				return A2(
					...
					function (response) {
						return A3($author$project$Extra$System$IO$Port$lowLevelSend, responseCodec, sendPort, response);
					});
			});
	});
